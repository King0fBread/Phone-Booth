...
// End Cross Module References
...
#endif
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_gearsArray_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_gearsArray;
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AGearsManager_Statics::NewProp_gearsArray_MetaData[] = {
		{ "Category", "GearActors" },
		{ "ModuleRelativePath", "GearsManager.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AGearsManager_Statics::NewProp_gearsArray = { "gearsArray", nullptr, (EPropertyFlags)0x0010000000000001, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AGearsManager, gearsArray), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AGearsManager_Statics::NewProp_gearsArray_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AGearsManager_Statics::NewProp_gearsArray_MetaData)) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AGearsManager_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AGearsManager_Statics::NewProp_gearsArray,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PhoneBooth_Source_PhoneBooth_GearsManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AGearsManager, AGearsManager::StaticClass, TEXT("AGearsManager"), &Z_Registration_Info_UClass_AGearsManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AGearsManager), 2240570003U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_PhoneBooth_Source_PhoneBooth_GearsManager_h_1807602954(TEXT("/Script/PhoneBooth"),
